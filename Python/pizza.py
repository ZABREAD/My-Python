import turtle
background="#9EC388" #background color
crust="#ECA84F" #crust color
sauce="#AD0509" #sauce color
cheese="#FBC70F" #cheese color
pepperoni=[[-70,105],[-85,175],[-25,50],[-15,100],[-25,150],[-30,205],[15,50],[20,120],[20,200],[60,156],[71,215],[80,90]]
screen=turtle.Screen()
screen.bgcolor(background)
screen.title("my pizza") #screen title
my_turtle=turtle.Turtle()
my_turtle.pensize(5) #pensize
my_turtle.shape("circle") #turtle shape
